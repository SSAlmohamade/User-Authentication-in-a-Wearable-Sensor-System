...
class Input_Attcker:
    ...
    def Creatprofile(self, user, Trail,
        ...
        for n in range(len(thumb_force_Feature)):
            ...
            Attack.ExportFeatures('forgeid_Sample_450_3best_2/Attack_sample_'+str(target_user), profile)
            # np.savetxt('forgeid_Sample_50_3best/Attack_sample_' + str(target_user) + '.csv', profile, delimiter=',')
    ...
    def FindFeatures(self, Tool_featuer):
        ...
        X = tsfel.time_series_features_extractor(cfg, Tool_featuer,
                                                 fs=50)  # Receives a time series sampled at 50 Hz, divides into windows of size 250 (i.e. 5 seconds) and extracts all features
    ...
    def Create_forgeid_Sample(self,AttackSample):
        ...
        for n in range(0, NoFakeSample):
            ...
            for i in Attackdata:
                ...
                print ('rang=[',i[0],',', i[0]+edgesSize,']U[',i[1],',', i[1]+edgesSize,']U[',i[2],',', i[2]+edgesSize,']')
...
if __name__ == '__main__':
    ...
    for t in taregt:
        ...
        print('after removeed taregt',userID)
